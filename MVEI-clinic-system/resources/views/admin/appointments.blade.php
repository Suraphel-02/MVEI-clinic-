...
<body class="flex h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white">
    ...
    <aside class="w-64 bg-white dark:bg-gray-800 shadow-md flex flex-col">
            ...
            <nav class="flex-1 p-6 space-y-2">
                ...
                <a href="{{ route('admin.appointments') }}" class="flex items-center py-2 px-4 text-blue-600 dark:text-blue-400 rounded-lg bg-blue-100 dark:bg-blue-900"><i class="fas fa-calendar-alt mr-3"></i>Appointments</a>
    ...
    <div class="flex-1 flex flex-col">
        ...
        <header class="w-full bg-white dark:bg-gray-800 shadow-md p-6 flex items-center justify-between">
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Appointments Management</h2>
        ...
        <main class="flex-1 p-6 bg-gray-100 dark:bg-gray-800">
                <div class="flex items-center justify-between mb-6">
                    <h1 class="text-3xl font-semibold text-gray-900 dark:text-white">Appointments</h1>
                            ...
                            <thead>
                                <thead class="bg-gray-50 dark:bg-gray-600">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Doctor Name</th>
                                ...
                                <tbody class="bg-white dark:bg-gray-700 divide-y divide-gray-200 dark:divide-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-200">Dr. Smith</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-200">2023-10-26</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-gray-200">10:00 AM</td>
